...
🎓 **Computer Science Student** | 💻 **Aspiring Data Engineer** | ⚡ **Big Data, Development & Dashboard Enthusiast**

---

I'm a passionate 2nd-year engineering student specializing in **Big Data Analytics** at Chandigarh University. I love building projects that combine **real-time data**, **automation**, **web development**, and **insightful dashboards** using tools like **Apache Kafka, Spark, PostgreSQL, Flask, and Power BI**.  
My goal? To turn complex data into clean, useful insights and build powerful applications that solve real-world problems. 💡
